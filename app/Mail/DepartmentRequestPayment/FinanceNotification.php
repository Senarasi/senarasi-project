...
class FinanceNotification extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            subject: '['.$this->departmentRequestPayment->department_request_payment_number . '] ' .  $this->departmentRequestPayment->user->name . ' just requested a payment',
        );
    }
    ...
    {
        return new Content(
            view: 'requestbudget.budgetdepartment.payment.mail.finance-notif',
        );
    }
