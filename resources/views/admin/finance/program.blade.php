            ...
            <div class="table-responsive p-2">
                ...
                <thead class="table-light">
                        <tr class="dicobain" style="">
                            ...
                            <th scope="col ">Budget Approve</th>
...
<!-- Modal 1 -->
                ...
                <div class="modal-body bg-white">
                    <form class="modal-form-check">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="namaprogram"class="selectize" id="namaprogram" required>
                                <option disabled selected>Select Program</option>
                                <option>Mata Najwa</option>
                                <option>Musyawarah</option>
                                <option>Festival Sambel</option>
                            </select>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <select id="quarter" class="form-select ">
                                    <option style="color: rgb(189, 189, 189) ">Choose Quarter</option>
                                    <option>QI</option>
                                    <option>QII</option>
                                    <option>QIII</option>
                                    <option>QIV</option>
                        ...
                        <div class="mb-3">
                            <label for="budgettahunan" class="form-label">Alocation Budget</label>
    ...
    <!--Modal 2-->
    <div class="modal justify-content-center fade" id="modal2"  data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body bg-white">
                        ...
                        <fieldset disabled>
                            <div class="departposisi">
                                <div
                                    ...
                                    <label for="departemen " class="form-label">Kode Budget</label>
