...
@section('content')
    <a href="{{ route('procurementitems') }}" class="text-decoration-none text-end">
    ...
    <form onsubmit="addPosisi(event)" action="" class="formrequest">
        ...
        <label for="barang" class="form-label">Items</label>
        ...
        <div class="garisbutton"><button type="button" onclick="addBarangInput()">Add Items</button></div>
...
function addBarangInput() {
    ...
    barangNameInput.placeholder = 'Name of Item';
    ...
    barangDescriptionInput.placeholder = 'Item Description';
    ...
    barangPriceInput.placeholder = 'Item Pricelist';
