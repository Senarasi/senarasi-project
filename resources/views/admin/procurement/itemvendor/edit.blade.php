...
@section('title')
    Items - Budgeting System
@endsection

@section('content')
    <a href="{{ route('procurement') }}" class="text-decoration-none text-end">
    ...
    <form action="" class="formrequest">
        <fieldset disabled>
            <div class="mb-3">
                <label for="disabledTextInput" class="form-label">Vendors Name</label>
        ...
        <div class="barangpricelist" style="display: grid; gap: 24px; grid-template-columns: 1fr 1fr;">
            <div class="mb-3">
                <label for="namabarang" class="form-label">Name of Items</label>
                <input type="text" class="form-control" id="namabarang" />
            </div>
            <div class=" mb-3 ">
                <label for="hargabarang" class="form-label">Item Pricelist</label>
