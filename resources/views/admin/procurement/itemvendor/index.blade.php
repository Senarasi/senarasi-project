...
@section('content')
    <!--Badan Isi-->
    <div class="judulhalaman" style=" display: flex; align-items: center; ">Items Pricelist</div>

    <div style="display: inline-flex; gap: 12px;">
        <a href="{{ route('procurementcreate') }}" type="button" class="button-departemen" style="text-decoration: none"> Add
            Items <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"
                fill="none">
        ...
        <div class="table-responsive p-2">
            ...
            style="font: 300 16px Narasi Sans, sans-serif; margin-top: 12px; display: 100%; width: 100% ;  color: #4A25AA;">
                <thead class="table-light">
                    <tr class="dicobain">
                        {{-- <th scope="col">No</th> --}}
                        <th scope="col" style="text-align:start;">Name of Item</th>
                        <th scope="col">Item Pricelist</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="gap: 8px; display: flex; justify-content: center;">
                            <a href="{{ route('procurementedit') }}" class="text-decoration-none text-end">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td style="gap: 8px; display: flex; justify-content: center;">
                            <a href="{{ route('vendor.item-vendor.edit') }}" class="text-decoration-none text-end">
                                <button type="button" class="uwuq" style="width: fit-content;">EDIT</button>
                            </a>
                            <button type="button" class="btn btn-danger" style="width: fit-content;">DELETE</button>
                        </td>
