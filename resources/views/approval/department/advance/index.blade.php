...
@section('content')
    ...
    <div class="judulhalaman" style="display: flex; align-items: center; ">Department Advance Approval
    </div>
        <div class="tablenih">
                    ...
                    <tbody>
                        <tr >
                            ...
                            <td style="gap: 8px; display: flex; justify-content: center; ">
                                <a href="{{ route('approval-budget-department.advance.detail') }}"  style="text-decoration: none"> <button type="button "
