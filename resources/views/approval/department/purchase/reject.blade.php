...
@section('content')
    <a class="navback"  href="{{ route('approval-budget-department.purchase.detail') }}" class="text-decoration-none text-end">
...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('.btn-add-note').forEach(function(button, index) {
        button.addEventListener('click', function() {
            ...
            const editorId = 'editor-' + index; // Use index to create unique ID
            const editorDiv = document.createElement('div');
            editorDiv.id = editorId;
            editorDiv.name = 'isireject'; // Assign name 'isireject' to the editor
            ...
            // Initialize Summernote in the new container
            $('#' + editorId).summernote({
...
function saveContent(content, editorId) {
    // Implement logic to save content to the server here
