...
@section('content')
    ...
    <div class="tablenih" style="margin-top: 12px;">
        <div class="content-section-unique">
            ...
            <form action="{{ route('audit_laptop.update', $laptopAudit->audit_laptop_id) }}" method="POST"
                ...
                <div class="row mb-3">
                        ...
                        <select id="employee_option" name="employee_id">
                            ...
                            @foreach ($users as $user)
                                <option value="{{ $user->employee_id }}"
                                    {{ $laptopAudit->employee_id == $user->employee_id ? 'selected' : '' }}>
                                    {{ $user->full_name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="laptop_number" id="laptop_number"
                            value="{{ old('laptop_number', $laptopAudit->laptop_number) }}">
                        @error('laptop_number')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="laptop_type" id="laptop_type"
                            value="{{ old('laptop_type', $laptopAudit->laptop_type) }}">
                        @error('laptop_type')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="serial_number" id="serial_number"
                            placeholder="Serial Laptop Number" value="{{ $laptopAudit->serial_number }}" required>
                    </div>
                    <div class="col">
                        ...
                        <input type="asset" class="form-control" name="no_asset" id="no_asset" placeholder="Asset Number"
                            value="{{ $laptopAudit->no_asset }}" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col ">
                        ...
                        <select name="processor" id="processor" class="form-control dynamic-select">
                            ...
                            <option value="Core i3" {{ $laptopAudit->processor == 'Core i3' ? 'selected' : '' }}>Core
                                i3</option>
                            <option value="Core i5" {{ $laptopAudit->processor == 'Core i5' ? 'selected' : '' }}>Core
                                i5</option>
                            <option value="Core i7" {{ $laptopAudit->processor == 'Core i7' ? 'selected' : '' }}>Core
                                i7</option>
                            <option value="Ryzen 5" {{ $laptopAudit->processor == 'Ryzen 5' ? 'selected' : '' }}>Ryzen
                                5</option>
                            <option value="Ryzen 7" {{ $laptopAudit->processor == 'Ryzen 7' ? 'selected' : '' }}>Ryzen
                                7</option>
                            <option value="other"
                                {{ !in_array($laptopAudit->processor, ['Core i3', 'Core i5', 'Core i7', 'Ryzen 5', 'Ryzen 7']) ? 'selected' : '' }}>
                                Other</option>
                        </select>
                        <input type="text" name="processor_other" id="processor_other"
                            class="form-control mt-2 other-input" placeholder="Enter Processor"
                            value="{{ !in_array($laptopAudit->processor, ['Core i3', 'Core i5', 'Core i7', 'Ryzen 5', 'Ryzen 7']) ? $laptopAudit->processor : '' }}"
                            style="display:{{ !in_array($laptopAudit->processor, ['Core i3', 'Core i5', 'Core i7', 'Ryzen 5', 'Ryzen 7']) ? 'block' : 'none' }};">
                        @error('processor')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col ">
                        ...
                        <select name="ram" id="ram" class="form-control dynamic-select">
                            ...
                            <option value="4GB" {{ $laptopAudit->ram == '4GB' ? 'selected' : '' }}>4GB</option>
                            <option value="8GB" {{ $laptopAudit->ram == '8GB' ? 'selected' : '' }}>8GB</option>
                            <option value="12GB" {{ $laptopAudit->ram == '12GB' ? 'selected' : '' }}>12GB</option>
                            <option value="16GB" {{ $laptopAudit->ram == '16GB' ? 'selected' : '' }}>16GB</option>
                            <option value="32GB" {{ $laptopAudit->ram == '32GB' ? 'selected' : '' }}>32GB</option>
                            <option value="other"
                                {{ !in_array($laptopAudit->ram, ['4GB', '8GB', '12GB', '16GB', '32GB']) ? 'selected' : '' }}>
                                Other</option>
                        </select>
                        <input type="text" name="ram_other" id="ram_other" class="form-control mt-2 other-input"
                            style="display:{{ !in_array($laptopAudit->ram, ['4GB', '8GB', '12GB', '16GB', '32GB']) ? 'block' : 'none' }};"
                            placeholder="Enter RAM"
                            value="{{ !in_array($laptopAudit->ram, ['4GB', '8GB', '12GB', '16GB', '32GB']) ? $laptopAudit->ram : '' }}">
                    </div>
                    <div class="col ">
                        <label for="ssd">SSD</label>
                        <select name="ssd" id="ssd" class="form-control dynamic-select">
                            <option value="">Select SSD</option>
                            <option value="256GB" {{ $laptopAudit->ssd == '256GB' ? 'selected' : '' }}>256GB</option>
                            <option value="512GB" {{ $laptopAudit->ssd == '512GB' ? 'selected' : '' }}>512GB</option>
                            <option value="1TB" {{ $laptopAudit->ssd == '1TB' ? 'selected' : '' }}>1TB</option>
                            <option value="2TB" {{ $laptopAudit->ssd == '2TB' ? 'selected' : '' }}>2TB</option>
                            <option value="other"
                                {{ !in_array($laptopAudit->ssd, ['256GB', '512GB', '1TB', '2TB']) ? 'selected' : '' }}>
                                Other
                            </option>
                        </select>
                        <input type="text" name="ssd_other" id="ssd_other" class="form-control mt-2 other-input"
                            style="display:{{ !in_array($laptopAudit->ssd, ['256GB', '512GB', '1TB', '2TB']) ? 'block' : 'none' }};"
                            placeholder="Enter SSD"
                            value="{{ !in_array($laptopAudit->ssd, ['256GB', '512GB', '1TB', '2TB']) ? $laptopAudit->ssd : '' }}">
                    </div>
                </div>
                <div class="judulhalaman mb-2"
                    style="font-size: 16px ;display: flex; align-items: center; margin:0px; padding: 0px">Laptop
                    Physical
                    Condition </div>
                ...
                <div class="row mb-3">
                    <div class="col ">
                        ...
                        <select id="charger" name="charger" placeholder="Choose Condition" required
                            ...
                            <option value="Good" {{ $laptopAudit->charger == 'Good' ? 'selected' : '' }}>Good
                            </option>
                            <option value="Damaged" {{ $laptopAudit->charger == 'Damaged' ? 'selected' : '' }}>Damaged
                            </option>
                            <option value="Missing" {{ $laptopAudit->charger == 'Missing' ? 'selected' : '' }}>Missing
                            </option>
                        </select>
                        <textarea name="charger_reason" id="charger_reason" class="form-control mt-2 reason-input"
                            placeholder="Provide reason for Damaged/Missing status"
                            style="display:{{ in_array($laptopAudit->charger, ['Damaged', 'Missing']) ? 'block' : 'none' }};">{{ $laptopAudit->charger_reason }}</textarea>
                    </div>
                    <div class="col ">
                        ...
                        <select id="lcd" name="lcd" placeholder="Choose Condition" required
                            class="form-control component-status">
                            <option disabled value="">Choose Condition</option>
                            <option value="Good" {{ $laptopAudit->lcd == 'Good' ? 'selected' : '' }}>Good</option>
                            <option value="Damaged" {{ $laptopAudit->lcd == 'Damaged' ? 'selected' : '' }}>Damaged
                            </option>
                            <option value="Missing" {{ $laptopAudit->lcd == 'Missing' ? 'selected' : '' }}>Missing
                            </option>
                        </select>
                        <textarea name="lcd_reason" id="lcd_reason" class="form-control mt-2 reason-input"
                            placeholder="Provide reason for Damaged/Missing status"
                            style="display:{{ in_array($laptopAudit->lcd, ['Damaged', 'Missing']) ? 'block' : 'none' }};">{{ $laptopAudit->lcd_reason }}</textarea>
                    </div>
                    <div class="col ">
                        ...
                        <select id="keyboard" name="keyboard" placeholder="Choose Condition" required
                            class="form-control component-status">
                            <option disabled value="">Choose Condition</option>
                            <option value="Good" {{ $laptopAudit->keyboard == 'Good' ? 'selected' : '' }}>Good
                            </option>
                            <option value="Damaged" {{ $laptopAudit->keyboard == 'Damaged' ? 'selected' : '' }}>
                                Damaged
                            </option>
                            <option value="Missing" {{ $laptopAudit->keyboard == 'Missing' ? 'selected' : '' }}>
                                Missing
                            </option>
                        </select>
                        <textarea name="keyboard_reason" id="keyboard_reason" class="form-control mt-2 reason-input"
                            placeholder="Provide reason for Damaged/Missing status"
                            style="display:{{ in_array($laptopAudit->keyboard, ['Damaged', 'Missing']) ? 'block' : 'none' }};">{{ $laptopAudit->keyboard_reason }}</textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col ">
                        ...
                        <textarea name="camera_reason" id="camera_reason" class="form-control mt-2 reason-input"
                            placeholder="Provide reason for Damaged/Missing status"
                            style="display:{{ in_array($laptopAudit->camera, ['Damaged', 'Missing']) ? 'block' : 'none' }};">{{ $laptopAudit->camera_reason }}</textarea>
                    </div>
                    <div class="col ">
                        ...
                        <select id="body" name="body" placeholder="Choose Condition" required
                            class="form-control component-status">
                            <option disabled value="">Choose Condition</option>
                            <option value="Good" {{ $laptopAudit->body == 'Good' ? 'selected' : '' }}>Good</option>
                            <option value="Damaged" {{ $laptopAudit->body == 'Damaged' ? 'selected' : '' }}>Damaged
                            </option>
                            <option value="Missing" {{ $laptopAudit->body == 'Missing' ? 'selected' : '' }}>Missing
                            </option>
                        </select>
                        <textarea name="body_reason" id="body_reason" class="form-control mt-2 reason-input"
                            placeholder="Provide reason for Damaged/Missing status"
                            style="display:{{ in_array($laptopAudit->body, ['Damaged', 'Missing']) ? 'block' : 'none' }};">{{ $laptopAudit->body_reason }}</textarea>
                    </div>
                    <div class="col ">
                        ...
                        <select id="speaker" name="speaker" placeholder="Choose Condition" required
                            class="form-control component-status">
                            <option disabled value="">Choose Condition</option>
                            <option value="Good" {{ $laptopAudit->speaker == 'Good' ? 'selected' : '' }}>Good
                            </option>
                            <option value="Damaged" {{ $laptopAudit->speaker == 'Damaged' ? 'selected' : '' }}>Damaged
                            </option>
                            <option value="Missing" {{ $laptopAudit->speaker == 'Missing' ? 'selected' : '' }}>Missing
                            </option>
                        </select>
                        <textarea name="speaker_reason" id="speaker_reason" class="form-control mt-2 reason-input"
                            placeholder="Provide reason for Damaged/Missing status"
                            style="display:{{ in_array($laptopAudit->speaker, ['Damaged', 'Missing']) ? 'block' : 'none' }};">{{ $laptopAudit->speaker_reason }}</textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col mb-3">
                        ...
                        <div class="row">
                            <div class="col">
                                <input type="number" name="battery_current_capacity" id="battery_current_capacity"
                                    ...
                                    value="{{ $laptopAudit->battery_current_capacity }}">
                            </div>
                            <div class="col">
                                <input type="number" name="battery_design_capacity" id="battery_design_capacity"
                                    ...
                                    value="{{ $laptopAudit->battery_design_capacity }}">
                            </div>
                        </div>
                    </div>
                    <div class="col mb-3">
                        <label for="other" class="form-label">Note</label>
                        <textarea class="form-control" name="other" id="other" cols="3" rows="3">{{ $laptopAudit->other }}</textarea>
                    </div>

                    <div class="col mb-3">
                        <label for="audit_status" class="form-label"s>Audit Status</label>
                        <select name="audit_status" id="audit_status" class="form-control">
                            <option value="Pending" {{ $laptopAudit->audit_status == 'Pending' ? 'selected' : '' }}>
                                Pending</option>
                            <option value="Completed" {{ $laptopAudit->audit_status == 'Completed' ? 'selected' : '' }}>
                                Completed</option>
                        </select>
                        <small class="form-text text-muted">
                            Note: The system will automatically set status based on form completeness
