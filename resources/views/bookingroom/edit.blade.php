    ...
    <div class="row justify-content-center" style="margin-top: -12px">
        ...
        <div class="col-lg-8 col-md-12 col-sm-12">
            ...
            <div class="tablenih" style="padding-top: -24px; margin-top: 32px;">
                ...
                <p style="font: 700 24px Narasi Sans, sans-serif; color: #4A25AA; margin: 12px;">
                    {{ $booking->room->room_name }} Calendar</p>
                ...
                <form method="POST" action="{{ route('bookingroom.update', $booking->id) }}" style="margin:12px">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('desc') is-invalid @enderror" id="inputdesc"
                            name="desc" value="{{ old('desc') ?? $booking->desc }} ">
                        @error('desc')
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    events: function(fetchInfo, successCallback, failureCallback) {
                        var room_id =
                            '{{ $booking->room->id }}'; // Get the room ID from the Blade variable
                        $.ajax({
                            url: '/getevents',
                            type: 'GET',
                            data: {
