...
<html>
<head>
    <title>Booking Room Cancelled</title>
    <style>
        body {
...
<body>
    <div style="background-color: #eeeeee; padding-top: 64px; padding-bottom: 64px;">
        ...
        <div class="email-container">
            <h3>Your Booking Room has been cancelled.</h3>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="value">: {{ $booking->employee->full_name }}</td>
                </tr>
                <tr>
                    <td class="label">CP Booking (WA)</td>
                    <td class="value">: {{ $booking->employee->phone }}</td>
                </tr>
                <tr>
