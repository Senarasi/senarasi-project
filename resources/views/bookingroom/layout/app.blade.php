...
<html lang="en">
    ...
    <body class="antialiased">
        <div class="wrapper">
            ...
            <div class="topbar">
                <a class="markuy {{ request()->routeIs('bookingroom.index','bookingroom.create' ) ? 'active' : '' }}" href="{{ route('bookingroom.index') }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <a class="markuy {{ request()->routeIs('bookingroom.list' ) ? 'active' : '' }}" href="{{ route('bookingroom.list') }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 24 22" fill="none">
                ...
                <a class="markuy {{ request()->routeIs('manage-rooms.index' ) ? 'active' : '' }}" href="{{ route('manage-rooms.index') }}"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
