                    ...
                    <tbody style="vertical-align: middle;" class="text-center">
                        @foreach ($bookings as $booking)
                            <tr>
                                ...
                                <td>
                                    <a style="text-decoration: none;" href="https://wa.me/+62{{ $booking->employee->phone }}" target="_blank">{{ $booking->employee->phone }}</a>
                                </td>
                                ...
                                <td>
                                    <a href="#" style="text-decoration: none;" class="show-guests"
                                        data-guests="{{ $booking->internalGuest->pluck('employee.full_name')->implode(', ') }}"
                                        data-externalguests="{{ $booking->externalGuest->pluck('email')->implode(', ') }}">
                                ...
                                <td>
                                    <span style="display: flex; gap: 8px; justify-content: center">
                                        @can('owner', $booking)
                                        <a href="{{ route('bookingroom.edit', $booking->booking_id) }}" type="button"
                                            class="uwuq">Edit</a>
                                        <form action="{{ route('bookingroom.destroy', $booking->booking_id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
...
@section('modal')
    <div class="modal justify-content-center fade" id="guestsModal" data-bs-keyboard="false" tabindex="-1"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered ">
            <div class="modal-content">
                <div class="modal-body  bg-white">
                    ...
                    <div class="mb-3">
                        <ul id="guestsList" class="list-group">
                    ...
                    <div class="mb-3">
                        <ul id="externalGuestsList" class="list-group">
