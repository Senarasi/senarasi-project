...
<div class="modal justify-content-center fade" id="modal-{{ $booking->id }}" data-bs-keyboard="false" tabindex="-1"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-body bg-white">
                <div class="row">
                    <div class="col mb-3" style="color: gray">Created Date
                        :{{ \Carbon\Carbon::parse($booking->created_at)->translatedFormat('d F Y H:i') }}</div>
                    <div class="col mb-3" style="color: gray">Update Date
                        :{{ \Carbon\Carbon::parse($booking->updated_at)->translatedFormat('d F Y H:i') }}</div>
                ...
                <div class="row ">
                    <div class="col">
                        ...
                        @if ($booking->hybrid)
                            <div class="mb-3">
                                <svg xmlns="http://www.w3.org/2000/svg" style="margin-right: 14px" width="16"
                                    height="16" viewBox="0 0 28 28" data-bs-toggle="tooltip" data-bs-placement="top"
                                    data-bs-custom-class="custom-tooltip" data-bs-title="Google Meet">
                                    <path fill="#4a25aa"
                                ...
                                @php
                                    $link = preg_replace('#^https?://#', '', $booking->hybrid->link);
                                @endphp
                                <span class="align-middle">
                                    <a href="{{ $booking->hybrid->link }}" target="_blank">{{ $link }}</a>
                                </span>
                            </div>
                        @endif
                        ...
                        <div class="mb-3">
                            ...
                            <span class="align-middle">{{ $booking->employee->full_name }}
                            </span>
                        </div>

                        <div class="mb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" style="margin-right: 14px;" height="16"
                                width="16" viewBox="0 0 512 512" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-bs-custom-class="custom-tooltip" data-bs-title="CP Booking (whatsapp)">
                                <!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                <path fill="#4a25aa"
                            ...
                            <span class="align-middle">
                                <a style="text-decoration: none; vertical-align: middle;"
                                    href="https://wa.me/+62{{ $booking->employee->phone }}"
                                    target="_blank">{{ $booking->employee->phone }}</a>
                        </div>
                        </span>
                        ...
                        <div class="mb-3">
                            ...
                            <span class="align-middle">
                                ...
                                @else
                                    {{ \Carbon\Carbon::parse($booking->start)->translatedFormat('d F Y') }} -
                                    {{ \Carbon\Carbon::parse($booking->end)->translatedFormat('d F Y') }}
                                @endif
                            </span>
                        ...
                        <div class="mb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" style="margin-right: 14px;" height="16"
                                width="16" viewBox="0 0 512 512" data-bs-toggle="tooltip" data-bs-placement="top"
                                data-bs-custom-class="custom-tooltip" data-bs-title="Time">
                                <!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                <path fill="#4a25aa"
                                    d="M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" />
                            </svg>
                            <span class="align-middle">
                                {{ \Carbon\Carbon::parse($booking->start)->format('H:i') }} -
                                {{ \Carbon\Carbon::parse($booking->end)->format('H:i') }}
                        </div>
                        </span>
                        ...
                        <div class="mb-3">
                            ...
                            <ul class="pt-2">
                                @foreach ($booking->guests as $guest)
                                    <li>{{ $guest->employee->full_name }}</li>
                                @endforeach
                ...
                <div class="modal-footer" style="border: none; margin-bottom: -12px">
                    ...
                    @if ($booking->isBookingDatePassed())
                        <button type="button" class="btn btn-primary disabled"
                            style="background-color: #4a25aa; border:0;">Edit</button>
                    @else
