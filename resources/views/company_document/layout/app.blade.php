...
<html lang="en">
    <head>
        ...
        <title>Company File Document - Senarasi</title>
        {{-- ngok meta tag --}}
    ...
    <body class="antialiased">
        <div class="wrapper">
            ...
            <div class="topbar">
                <a class="markuy" href="{{ route('company-document.index') }}"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="24" viewBox="0 0 19 24" fill="none">
