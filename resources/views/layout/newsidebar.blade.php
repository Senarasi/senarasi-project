    ...
    <div class="sidebar-footer" style="border-top: 3px solid #3b7ddd; ">
        ...
        <a href="{{ route('logout') }}" class="sidebar-link"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="20" viewBox="0 0 19 20"
                fill="none">
                <path
                    d="M6.5 3V2C6.5 1.44772 6.9477 1 7.5 1H16.5C17.0523 1 17.5 1.44772 17.5 2V18C17.5 18.5523 17.0523 19 16.5 19H7.5C6.9477 19 6.5 18.5523 6.5 18V17"
