...
@endsection
@section('content')
    <a href="{{ route('request-budget-department.advance.index') }}" class="navback" style="text-decoration: none;">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist" style="margin-bottom: 24px; font: 600 18px Narasi Sans, sans-serif; ">
        <li class="nav-item" role="presentation"  style="flex: 1; text-align: center;">
            <button class="nav-link active tablinks" id="data5-tab" data-url="{{ route('request-budget-department.advance.create') }}"
        ...
        <li class="nav-item" role="presentation"  style="flex: 1; text-align: center;">
            <button class="nav-link tablinks" id="preview-tab" data-url="{{ route('request-budget-department.advance.create.description') }}"
...
{{--
                ...
                <a href="{{ route('request-budget-department.advance.create.description') }}" class="button-departemen"
