    ...
    <body>
        <div style="background-color: #f9f9f9; padding-top: 64px; padding-bottom: 64px;">
            ...
            <div class="email-container">
                <h3>Dear {{ strtoupper($departmentRequestPayment->manager->full_name) }}, </h3>
                <h3>{{ strtoupper($departmentRequestPayment->user->full_name) }} needs your approval to request payment.</h3>
                ...
                <h3><a href="{{ route('approval-budget-department.payment.detail' , $departmentRequestPayment->department_request_payment_id  ) }}" class="button-report">Process
                        Approval</a></h3>
                <div>
                </div>
            </div>
