...
@section('content')
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link active tablinks" id="data5-tab" data-url="{{ route('requestbudget.location', $id) }}"
                        ...
                        <td>
                            ...
                            <form class="form-delete" onsubmit="return confirm('Konfirmasi hapus data ini?')"
                                ...
                                <input type="hidden" name="url_back"
                                    value="{{ route('requestbudget.location', $requestbudget->request_budget_id) }}">
