...
@section('content')
    <a href="/requestpayment" class="navback" style="text-decoration: none;">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist" style="margin-bottom: 24px; font: 600 18px Narasi Sans, sans-serif; ">
        <li class="nav-item" role="presentation"  style="flex: 1; text-align: center;">
            <button class="nav-link  tablinks" id="data5-tab" data-url="/requestpayment-create"
        ...
        <li class="nav-item" role="presentation"  style="flex: 1; text-align: center;">
            <button class="nav-link active tablinks" id="preview-tab" data-url="/requestpayment-description"
            ...
            <div class="modal-content">
                <div class="modal-body bg-white">
                    <form action="" method="POST" class="modal-form-check"
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                    <label for="accountnumber" class="form-label">Account Number / VA</label>
                                    <input type="text" class="form-control" id="accountnumber" name="accountnumber"  style="padding: 8px"/>
                            </div>
                            <div class="col mb-3">
                                    <label for="accountname" class="form-label">Account Name</label>
                                    <input type="text" class="form-control" id="accountname" name="accountname"  style="padding: 8px"/>
                            </div>
                        </div>
                        <div class="mb-3">
