...
@section('title')
    Budget Request - Budgeting System
@endsection

@section('content')

    <div class="judulhalaman" style="display: flex; align-items: center; ">Program Budget Request</div>
        ...
        <div class="table-responsive p-3">
            <table id="datatable" class="table table-hover "
                ...
                <thead class="table-light">
                    <tr class="dicobain" style="padding-left: 0px">
                        <th scope="col ">Request Number</th>
                        <th scope="col ">Program Name</th>
                        <th scope="col ">Manager</th>
                        <th scope="col " style="width: 9%; ">Studio Production</th>
                        <th scope="col " style="width: 9%; ">Human Capital</th>
                        <th scope="col " style="width: 9%; ">Controller Manager</th>
                    ...
                    @forelse ($requestBudgets as $data)
                        <tr>
                            ...
                            @if (($data->approval->where('stage', 'manager')->first()->status ?? '-') == 'pending')
                                <td class="buletan"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            @elseif (($data->approval->where('stage', 'reviewer')->first()->status ?? '-') == 'approved')
                                <td class="buletan"><svg xmlns="http://www.w3.org/2000/svg" width="24"
