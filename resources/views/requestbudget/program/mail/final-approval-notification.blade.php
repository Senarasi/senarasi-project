    ...
    <body>
        <div style="background-color: #f9f9f9; padding-top: 64px; padding-bottom: 64px;">
            ...
            <div class="email-container">
                ...
                <h3>Your request budget has been approve </h3>
                <table>
                    <tr>
                        <td class="label">Status</td>
                        <td>: <span class="alert alert-success">{{ strtoupper('PENDING') }}</span></td>
                    </tr>
                    <tr>
                ...
                <h3><a  href="{{ config('app.url') }}/request-budget/{{ $requestBudget->request_budget_id }}" class="button-report" >Detail Approval</a></h3>
                <div>
                </div>
            </div>
        </div>
