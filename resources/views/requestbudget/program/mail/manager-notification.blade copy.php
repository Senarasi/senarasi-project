...
<html>
<head>
    <title>Budget Request Notification</title>
</head>
<body>
    <h1>Budget Request Notification</h1>
    <p>Dear {{ $requestBudget->manager->full_name }},</p>
    <p>A budget request has been {{ $isResubmission ? 'resubmitted' : 'submitted' }} for your review.</p>
    <p><strong>Request ID:</strong> {{ $requestBudget->budget_code }}</p>
    ...
    <p>Please review the request at your earliest convenience. The report is attached to this email.</p>
    <p>Thank you.</p>
</body>
</html>
...
<body>
    <div style="background-color: #f9f9f9; padding-top: 64px; padding-bottom: 64px;">
        ...
        <div class="email-container">
            <h3>Dear {{ $requestBudget->manager->full_name }}, </h3>
            <h3>{{ $requestBudget->employee->full_name }} needs your approval to request budget.</h3>
            <h4>Request Budget detail:</h4>
            <table>
                <tr>
                    <td class="label">Status</td>
                    <td>: <span class="alert alert-success">{{ $currentStage }}</span></td>
                </tr>
                <tr>
