...
<body>
    <div style="background-color: #f9f9f9; padding-top: 64px; padding-bottom: 64px;">
        ...
        <div class="email-container">
            <h3>{{ $transportrequest->user->name }} needs your approval to request a transport.</h3>
            <h4>Request transport detail:</h4>
            <table>
                <tr>
            ...
            <h3><a  href="{{ route('approval-head-transport.detail', $transportrequest->id) }}" class="button-report" >Process Approval</a></h3>
            <div>
            </div>
        </div>
    </div>
