...
@section('content')
 <div style="margin-left: 24px">
        ...
        <div style="display: inline-flex; gap: 12px; margin-left:4px;">
            <a href="/transport-request/create" type="button" class="button-departemen" style="text-decoration: none"> Add
                Transportion Request <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"
                    fill="none">
