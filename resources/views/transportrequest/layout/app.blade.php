...
<html lang="en">
    ...
    <body class="antialiased">
        <div class="wrapper" style="display: flex">
            ...
            @include('transportrequest.layout.sidebar_transport')
            {{-- <div style="margin-top: 68px"></div> --}}
            {{-- <div class="topbar">
                <a class="markuy {{ request()->routeIs('bookingroom.index','bookingroom.create', 'bookingroom.edit' ) ? 'active' : '' }}" href="{{ route('bookingroom.index') }}">
                ...
                <a class="markuy {{ request()->routeIs('bookingroom.list' ) ? 'active' : '' }}" href="{{ route('bookingroom.list') }}">
                ...
                <a class="markuy {{ request()->routeIs('manage-rooms.index' ) ? 'active' : '' }}" href="{{ route('manage-rooms.index') }}">
